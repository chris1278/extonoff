...
$lang = array_merge($lang, [
	'EXTONOFF_EXPLAIN'						=> 'Hier haben Sie die Möglichkeit alle Erweiterungen auf einmal zu deaktivieren bzw. zu aktivieren.<br><br>Zusätzlich haben Sie die Möglichkeit auch entsprechend die Buttons direkt in der Ansicht <b>„Erweiterungen verwalten“</b> anzeigen zu lassen und diese dort zu nutzen.<br><br><b style="color: red">Achtung:</b>  Es lassen sich nur installierte Erweiterungen aktivieren bzw. deaktivieren. Die Erweiterungen die zwar in der Liste aufgeführt, aber noch nicht installiert sind, werden dabei nicht berücksichtigt.',
	...
	'EXTONOFF_ACTIVATION_SUCCESFULL'		=> 'Alle %u deaktivierten Erweiterungen wurden erfolgreich aktiviert.',
	...
	'EXTONOFF_DEACTIVATE_EXPLAIN'			=> 'Durch drücken des Buttons <b>„Alle Erweiterungen deaktivieren“</b> werden alle installierten und aktivierten Erweiterungen deaktiviert.<br><br><b>Hinweis:</b> Die Erweiterung <b>„Enable/disable extensions completely“</b> bleibt dabei aktiviert. Diese müssen Sie dann manuell deaktivieren.',
	'EXTONOFF_ALL_DEACTIVATE'				=> 'Alle Erweiterungen deaktivieren',
	'EXTONOFF_DEACTIVATION_SUCCESFULL'		=> 'Alle %u aktivierten Erweiterungen wurden erfolgreich deaktiviert.',
	...
	'EXTONOFF_ENABLE_BUTTONS_EXPLAIN'		=> 'Wenn Sie diese Option aktivieren, werden in der Ansicht <b>„Erweiterungen verwalten“</b> ebenfalls Buttons eingeblendet, mit denen Sie auch dort alle Erweiterungen aktiveren bzw. deaktivieren können.',
	'EXTONOFF_ADMIN_LOG'					=> 'Log-Eintrag Ein-/Ausschalten',
	'EXTONOFF_ENABLE_LOG'					=> 'Log-Eintrag Aktivieren',
	'EXTONOFF_ENABLE_LOG_EXPLAIN'			=> 'Hier können Sie den Log-Eintrag den Sie im Wartungsbereich des Forums finden steuern. Wenn Sie den Log-Eintrag deaktivieren, wird kein Eintrag mehr in die Liste der Log-Einträge hinzugefügt. Dies betrifft nur die Einträge die durch die Erweiterung <b>„Erweiterungen komplett aktivieren/deaktivieren“</b> im Log vermerkt werden.<br><br><b>Standard:</b> Ja',

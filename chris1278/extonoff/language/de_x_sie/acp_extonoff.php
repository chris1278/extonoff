...
$lang = array_merge($lang, [
	'EXTONOFF_EXPLAIN'										=> 'Hier haben Sie die Möglichkeit alle Erweiterungen auf einmal zu deaktivieren bzw. zu aktivieren.<br><br>Hier können Sie alle Extensions die Aktiviert sind mittels der Buttons entweder alle aktivieren oder alle deaktivieren.<br><br>Zusätzlich haben Sie die Möglichkeit auch entsprechend die Buttons direkt in der Ansicht <b>"Erweiterungen verwalten"</b> anzeigen zu lassen und diese dort zu nutzen.<br><br><b style="color: red">Achtung:</b>  Es lassen sich nur die Erweiterungen die auch installiert sind aktivieren bzw. deaktivieren. Die Erweiterungen die zwar in der Liste sind, aber noch nicht installiert sind, werden dadurch nicht berücksichtigt.',
